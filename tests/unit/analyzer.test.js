...
describe('ASTAnalyzer', () => {
    ...
    beforeAll(async () => {
        ...
        await fs.writeFile(path.join(testDir, 'simple_class.py'), `"""
...
`);
        await fs.writeFile(path.join(testDir, 'complex_functions.py'), `"""Complex function examples."""
...
`);
        await fs.writeFile(path.join(testDir, 'parse_error.py'), `"""File with intentional syntax errors."""
